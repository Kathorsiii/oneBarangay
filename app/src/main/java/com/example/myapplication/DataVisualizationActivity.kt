...
class DataVisualizationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        responseLiveData.observe(this, Observer {
            dataViz = it.body()!!
            setDataToAgeGroupChart(binding.pieChartAgeGroup)
            setDataToSocialClassChart(binding.barChartSocialClass)
            setDataToCivilStatusChart(binding.barChartCivilStatus)
        })
    }
